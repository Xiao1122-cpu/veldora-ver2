        ...
        <div class="container" style="margin-top: 50px;">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="main-container mx-auto" v-if="newsDetail">
                        ...
                        <img :src="newsDetail.image" alt="" class="w-100 mt-4"
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow-sm p-3 comment-box">
                        <h5 class="mb-3">Bình luận</h5>

                        <!-- Danh sách bình luận có class="comment-list" -->
                        ...
                        <div v-if="currentUser" class="mt-2">
                            <textarea v-model="newComment" class="form-control mb-2" placeholder="Nhập bình luận..."
                                rows="3"></textarea>
                            <button class="btn btn-primary w-100" @click="addComment" :disabled="!newComment.trim()">
                                Gửi bình luận
                            </button>
                        </div>
...
/* Khung bình luận có chiều cao cố định */
.comment-box {
    height: 600px;
    /* cố định chiều cao tổng thể */
    display: flex;
    flex-direction: column;
    overflow: hidden;
}

/* Vùng danh sách bình luận bên trong cuộn */
.comment-list {
    flex: 1;
    overflow-y: auto;
    margin-bottom: 10px;
